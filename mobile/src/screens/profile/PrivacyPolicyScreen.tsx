    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.paragraph}>
          Welcome to Manifest the Unseen ("we," "our," or "us"). We are committed to protecting your
        ...
        <Text style={styles.bulletPoint}>{'\u2022'} Account information (email address, name)</Text>
        ...
        <Text style={styles.paragraph}>
          When you use voice journaling features, audio is processed entirely on your device using
          on-device transcription technology. Audio recordings are never uploaded to our servers.
          Only the transcribed text is stored in your account, ensuring maximum privacy for your
          voice content.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          information. Your journal entries and personal data are encrypted both in transit and at
          rest. We use industry-standard security protocols and regularly review our security
          practices.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          provide you services. You can request deletion of your account and associated data at any
