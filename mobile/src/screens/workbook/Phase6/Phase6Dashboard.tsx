...
import { PhaseImages, Phase6ExerciseImages } from '../../../assets';
import {
  usePhaseExercises,
  type ExerciseConfig,
...
const PHASE6_EXERCISES: ExerciseConfig[] = [
  {
    ...
    icon: Phase6ExerciseImages.method369,
  ...
  },
  {
    ...
    icon: Phase6ExerciseImages.scripting,
  ...
  },
  {
    ...
    icon: Phase6ExerciseImages.woop,
    ...
    >
      ...
      <View style={styles.newHeader}>
        <View style={styles.headerImageContainer}>
          <Image source={PhaseImages.phase6} style={styles.headerImage} resizeMode="cover" />
        </View>
        <Text style={styles.headerTitle}>Manifestation Techniques</Text>
        <Text style={styles.headerSubtitle}>
          Master powerful manifestation methods including the 3-6-9 technique, scripting, and the
          WOOP framework
        </Text>
      </View>
