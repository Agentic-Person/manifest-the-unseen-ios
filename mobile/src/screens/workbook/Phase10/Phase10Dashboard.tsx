    ...
    >
      ...
      <View style={styles.newHeader}>
        <View style={styles.headerImageContainer}>
          <Image source={PhaseImages.phase10} style={styles.headerImage} resizeMode="cover" />
        </View>
        <Text style={styles.headerTitle}>Letting Go</Text>
        <Text style={styles.headerSubtitle}>
          Complete your journey. Review your growth, write to your future self, and celebrate your
          transformation
        </Text>
      </View>
