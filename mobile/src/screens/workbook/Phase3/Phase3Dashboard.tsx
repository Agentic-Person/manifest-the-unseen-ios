 ...
 */
const PHASE3_EXERCISES: ExerciseConfig[] = [
  {
    id: 'smart-goals',
    name: 'SMART Goals',
    description: 'Set specific, measurable, achievable goals',
    icon: Phase3ExerciseImages.smartGoals,
  ...
  },
  {
    ...
    icon: Phase3ExerciseImages.timeline,
  ...
  },
  {
    ...
    icon: Phase3ExerciseImages.actionPlan,
...
const Phase3Dashboard: React.FC<Props> = ({ navigation }) => {
  ...
  const {
    ...
    error,
    refetch,
  } = usePhaseExercises(3, PHASE3_EXERCISES);
  /**
    ...
    >
      ...
      <View style={styles.newHeader}>
        <View style={styles.headerImageContainer}>
          <Image source={PhaseImages.phase3} style={styles.headerImage} resizeMode="cover" />
        </View>
        <Text style={styles.headerTitle}>Goal Setting</Text>
        <Text style={styles.headerSubtitle}>
          Transform your vision into concrete, achievable goals with clear timelines and action
          plans
        </Text>
      </View>
