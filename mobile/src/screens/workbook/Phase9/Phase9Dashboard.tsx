...
const PHASE9_EXERCISES: ExerciseConfig[] = [
  {
    ...
    icon: Phase9ExerciseImages.trustAssessment,
  ...
  },
  {
    ...
    icon: Phase9ExerciseImages.surrenderPractice,
  ...
  },
  {
    ...
    icon: Phase9ExerciseImages.synchronicity,
    ...
    >
      ...
      <View style={styles.newHeader}>
        <View style={styles.headerImageContainer}>
          <Image source={PhaseImages.phase9} style={styles.headerImage} resizeMode="cover" />
        </View>
        <Text style={styles.headerTitle}>Trust & Surrender</Text>
        <Text style={styles.headerSubtitle}>
          Develop deep trust in yourself and the universe. Learn the art of surrender and letting go
        </Text>
      </View>
