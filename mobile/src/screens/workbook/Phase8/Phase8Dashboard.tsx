...
const PHASE8_EXERCISES: ExerciseConfig[] = [
  {
    ...
    icon: Phase8ExerciseImages.envyInventory,
  ...
  },
  {
    ...
    icon: Phase8ExerciseImages.inspirationReframe,
  ...
  },
  {
    ...
    icon: Phase8ExerciseImages.roleModels,
    estimatedTime: '15 min',
  },
];
...
const Phase8Dashboard: React.FC<Props> = ({ navigation }) => {
  ...
  const {
    ...
    overallProgress,
    isLoading,
  } = usePhaseExercises(8, PHASE8_EXERCISES);
    ...
    >
      ...
      <View style={styles.newHeader}>
        ...
        <Text style={styles.headerSubtitle}>
          Transform feelings of envy into powerful inspiration by learning from those you admire
        </Text>
      </View>
