  ...
  return (
    <div className={`space-y-8 ${className}`}>
      ...
      <div className="bg-gradient-to-r from-yellow-100 via-pink-100 to-purple-100 border-2 border-yellow-300 rounded-xl p-8 text-center">
        ...
        <h2 className="text-3xl font-bold text-enlightened mb-2">Congratulations!</h2>
        <p className="text-lg text-muted-wisdom">
      ...
      <div className="bg-elevated border border-[rgba(196,160,82,0.2)] rounded-lg p-4">
        <div className="flex gap-3">
          ...
          <div>
            <h4 className="text-sm font-semibold text-enlightened mb-1">Your Graduation Ceremony</h4>
      ...
      <div className="bg-elevated rounded-xl border-2 border-[rgba(196,160,82,0.2)] p-6">
        <label className="block text-lg font-semibold text-enlightened mb-3">Completion Date</label>
        <input
          type="date"
          value={data.completion_date}
          onChange={(e) => handleUpdateField('completion_date', e.target.value)}
          className="w-full p-3 border-2 border-[rgba(196,160,82,0.2)] rounded-lg focus:ring-2 focus:ring-purple-500 focus:outline-none text-lg"
        />
      </div>

      {/* Ongoing Commitments */}
      <div className="bg-elevated border-2 border-blue-300 rounded-xl p-6">
        <label className="block text-lg font-semibold text-enlightened mb-3">My Ongoing Commitments</label>
        ...
        <div className="space-y-3">
          {data.commitments.map((commitment, idx) => (
            <div key={idx} className="flex items-start gap-3">
              ...
              <input
                ...
                className="flex-1 p-3 border-2 border-[rgba(196,160,82,0.2)] rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none bg-elevated"
              />
          ...
          <button
            ...
            className="w-full py-3 border-2 border-dashed border-blue-300 rounded-lg hover:border-blue-500 hover:bg-elevated transition-all flex items-center justify-center gap-2 text-blue-600 font-semibold text-sm"
          >
      ...
      <div className="bg-elevated border-2 border-green-300 rounded-xl p-6">
        <label className="block text-lg font-semibold text-enlightened mb-3">Rituals to Maintain</label>
        ...
        <div className="space-y-3">
          {data.rituals_to_maintain.map((ritual, idx) => (
            <div key={idx} className="flex items-start gap-3">
              ...
              <input
                ...
                className="flex-1 p-3 border-2 border-heart-emerald rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none bg-elevated"
              />
          ...
          <button
            ...
            className="w-full py-3 border-2 border-dashed border-green-300 rounded-lg hover:border-green-500 hover:bg-elevated transition-all flex items-center justify-center gap-2 text-green-600 font-semibold text-sm"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
      ...
      <div className="bg-elevated rounded-xl border-2 border-[rgba(196,160,82,0.2)] p-6 shadow-md">
        <label className="block text-lg font-semibold text-enlightened mb-3">Final Reflections</label>
        <textarea
          ...
          rows={8}
          className="w-full p-4 border-2 border-aged-gold rounded-lg focus:ring-2 focus:ring-purple-500 focus:outline-none resize-y"
      ...
      <div className="bg-elevated border-2 border-pink-300 rounded-xl p-6">
        <label className="block text-lg font-semibold text-enlightened mb-3">How Will You Celebrate?</label>
        <textarea
          ...
          rows={4}
          className="w-full p-4 border-2 border-[rgba(196,160,82,0.2)] rounded-lg focus:ring-2 focus:ring-pink-500 focus:outline-none resize-y bg-elevated"
        />
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-100 via-pink-100 to-orange-100 border-2 border-purple-300 rounded-xl p-8 text-center">
        <p className="text-2xl font-bold text-enlightened mb-4">
