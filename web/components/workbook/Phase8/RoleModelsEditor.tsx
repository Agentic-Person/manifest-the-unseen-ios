...
export function RoleModelsEditor({ data, onChange, className = '' }: RoleModelsEditorProps) {
  ...
  return (
    <div className={`space-y-8 ${className}`}>
      {/* Introduction */}
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-[rgba(196,160,82,0.2)] rounded-lg p-4">
      ...
      {data.models.length > 0 ? (
        <div className="space-y-6">
          {data.models.map((model, index) => (
            <div key={model.id} className="bg-elevated rounded-xl border-2 border-[rgba(196,160,82,0.2)] shadow-lg overflow-hidden">
              {/* Header */}
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 border-b-2 border-[rgba(196,160,82,0.2)]">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <label className="block text-sm font-semibold text-muted-wisdom">
                        Role Model Name
                      </label>
                    </div>
                    <input
                      ...
                      className="w-full p-3 border-2 border-[rgba(196,160,82,0.2)] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg font-semibold"
                    />
                  </div>
              ...
              <div className="p-6 space-y-6">
                    ...
                    {model.qualities.map((quality, qualityIndex) => (
                      <div key={qualityIndex} className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          className="flex-1 p-3 border-2 border-aged-gold rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full p-3 border-2 border-aged-gold rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-y"
                  />
                </div>
                ...
                <div className="bg-elevated border-2 border-green-300 rounded-lg p-4">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full p-3 border-2 border-heart-emerald rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent resize-y bg-elevated"
                  />
                </div>
                ...
                <div className="bg-elevated border-2 border-purple-300 rounded-lg p-4">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full p-3 border-2 border-[rgba(196,160,82,0.2)] rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-y bg-elevated"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="text-center py-16 bg-elevated rounded-xl border-2 border-dashed border-aged-gold">
          ...
          <p className="text-muted-wisdom font-semibold mb-2">No role models yet</p>
          <p className="text-sm text-tertiary-text">Who inspires you? Add them here.</p>
        </div>
      )}

      {/* Tips */}
      <div className="bg-elevated border border-aged-gold rounded-xl p-6">
        <h3 className="text-lg font-semibold text-enlightened mb-4">Tips for Choosing Role Models</h3>
