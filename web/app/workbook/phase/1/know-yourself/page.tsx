...
import { KnowYourselfEditor, KnowYourselfData } from '@/components/workbook/Phase1/KnowYourselfEditor'
...
export default function KnowYourselfPage() {
    ...
    const loadData = async () => {
      try {
        ...
        if (error && error.code !== 'PGRST116') {
          ...
          setData(existing.data as KnowYourselfData)
        }
      } catch (err) {
  ...
  return (
    <WorksheetLayout
      ...
      onPrevious={() => router.push('/workbook/phase/1/comfort-zone')}
      previousLabel="Previous Worksheet"
    >
      <KnowYourselfEditor data={data} onChange={setData} />
    </WorksheetLayout>
  )
}
